...
for embed_dim in [100, 200, 300]:
    print('Loading Glove embedding of size ', embed_dim)
    embedding_glove = GloVe(name='6B', dim=embed_dim)

    vector_embedding_size = embed_dim
    ...
    def word2vec_pretrained(sentence, sent_len, embedding_size):
        ...
        for word in word_list:
            arr.append(list(embedding_glove[word]))
